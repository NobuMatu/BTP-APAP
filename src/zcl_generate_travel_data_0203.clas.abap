CLASS zcl_generate_travel_data_0203 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_0203 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:itab TYPE TABLE OF ztravel_0203.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_0203.

*   insert the new table entries
    INSERT ztravel_0203 FROM TABLE @itab.

*   check the result
    SELECT * FROM ztravel_0203 INTO TABLE @itab.
    out->write( sy-dbcnt ).
